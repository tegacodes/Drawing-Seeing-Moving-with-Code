...
socket.on('new-boid', function (data) {
  console.log('new boid!', data);
  var b = new Boid(data.x, data.y, data.color);
  b.velocity.x = data.vel.x;
  b.velocity.y = data.vel.y;
  flock.addBoid(b);
});

socket.on('all-boids', function(allboids) {
...
function mouseClicked() {
  var b = new Boid(mouseX,mouseY, myColor);
  flock.addBoid(b);
  socket.emit('new-boid', { x: mouseX, y: mouseY, color: myColor, vel: {x: b.velocity.x, y: b.velocity.y }} );
}
