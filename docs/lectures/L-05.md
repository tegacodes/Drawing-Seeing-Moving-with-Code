...
* As seen in the Mechanical Turk, chess has always been a site where artificial intelligence has been tested. 1996 was a devastating year for human chess, being the first time a computer, [IBM's deep blue,](https://en.wikipedia.org/wiki/Deep_Blue_(chess_computer)) beat a grand master chess player.
* More recently, human computer collaborative teams are now leading chess in a form of called ['Advanced Chess' or 'Centaur Chess'.](https://en.wikipedia.org/wiki/Advanced_Chess) They take advantage of the unpredictability of a human and the 'brute force' of a calculating machine.
* For more on this, watch this great talk by [James Bridle on chess and AI in sports.](https://www.youtube.com/watch?v=PNq0jZvctJE). The whole thing is great but particularly from 16min-29min where he explores chess, how computers are used for refereeing sports, and what that shows us about our attitudes towards computers making decisions that were once made by humans. Think of how this is playing out in the context of warfare and policing.
* On the upside, surely the computers would prevent this whole dreadful 'hand of god' situation from happening again...
